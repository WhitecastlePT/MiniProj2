          ...
          <b-card class="overflow-hidden" style="max-width: 1540px; ">
            <b-row>
              <b-col md="6" align="center">
                <b-card-img
                  :src="animal.links[currentImageIndex].url"
                ...
                {{ animal.links.length }}&nbsp;
                <b-button variant="danger" class="mr-2" @click="nextImage()">
  ...
  methods: {
    previousImage() {
      if (this.currentImageIndex > 0) {
        ...
        this.currentImageIndex = this.animal.links.length - 1;
      }
    },
    nextImage() {
      if (this.currentImageIndex < this.animal.links.length - 1) {
        this.currentImageIndex++;
      } else {
